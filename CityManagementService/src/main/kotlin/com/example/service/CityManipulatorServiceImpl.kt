...
@Stateless
open class CityManipulatorService : CityManipulatorServiceRemote {
    ...
    override fun getCity(id: Long) {
        TODO("Not yet implemented")
    }

    override fun updateCity(id: Long, updatedCity: City) {
        TODO("Not yet implemented")
    }
    ...
    override fun getSeaLevelSum() {
        TODO("Not yet implemented")
    }

    override fun getByNamePrefix(prefix: String) {
        TODO("Not yet implemented")
    }


    override fun applyFilter(cityList: List<City>, filter: String): List<City> {
    ...
    override fun applySort(cityList: List<City>, sort: String): List<City> {
        return when (sort) {
    ...
    override fun applyPagination(cityList: List<City>, page: Int, size: Int): List<City> {
